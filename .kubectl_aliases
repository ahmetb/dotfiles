...
alias kgage='kubectl get --sort-by=.metadata.creationTimestamp'
alias ksysgage='kubectl --namespace=kube-system get --sort-by=.metadata.creationTimestamp'
alias kgpoage='kubectl get pods --sort-by=.metadata.creationTimestamp'
alias ksysgpoage='kubectl --namespace=kube-system get pods --sort-by=.metadata.creationTimestamp'
alias kgdepage='kubectl get deployment --sort-by=.metadata.creationTimestamp'
alias ksysgdepage='kubectl --namespace=kube-system get deployment --sort-by=.metadata.creationTimestamp'
alias kgstsage='kubectl get statefulset --sort-by=.metadata.creationTimestamp'
alias ksysgstsage='kubectl --namespace=kube-system get statefulset --sort-by=.metadata.creationTimestamp'
alias kgsvcage='kubectl get service --sort-by=.metadata.creationTimestamp'
alias ksysgsvcage='kubectl --namespace=kube-system get service --sort-by=.metadata.creationTimestamp'
alias kgingage='kubectl get ingress --sort-by=.metadata.creationTimestamp'
alias ksysgingage='kubectl --namespace=kube-system get ingress --sort-by=.metadata.creationTimestamp'
alias kgcmage='kubectl get configmap --sort-by=.metadata.creationTimestamp'
alias ksysgcmage='kubectl --namespace=kube-system get configmap --sort-by=.metadata.creationTimestamp'
alias kgsecage='kubectl get secret --sort-by=.metadata.creationTimestamp'
alias ksysgsecage='kubectl --namespace=kube-system get secret --sort-by=.metadata.creationTimestamp'
alias kgnoage='kubectl get nodes --sort-by=.metadata.creationTimestamp'
alias kgnsage='kubectl get namespaces --sort-by=.metadata.creationTimestamp'
...
alias kgallage='kubectl get --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgpoallage='kubectl get pods --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgdepallage='kubectl get deployment --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgstsallage='kubectl get statefulset --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgsvcallage='kubectl get service --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgingallage='kubectl get ingress --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgcmallage='kubectl get configmap --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgsecallage='kubectl get secret --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgnsallage='kubectl get namespaces --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgageall='kubectl get --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgpoageall='kubectl get pods --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgdepageall='kubectl get deployment --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgstsageall='kubectl get statefulset --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgsvcageall='kubectl get service --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgingageall='kubectl get ingress --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgcmageall='kubectl get configmap --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgsecageall='kubectl get secret --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgnsageall='kubectl get namespaces --sort-by=.metadata.creationTimestamp --all-namespaces'
...
alias kgslage='kubectl get --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgslage='kubectl --namespace=kube-system get --show-labels --sort-by=.metadata.creationTimestamp'
alias kgposlage='kubectl get pods --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgposlage='kubectl --namespace=kube-system get pods --show-labels --sort-by=.metadata.creationTimestamp'
alias kgdepslage='kubectl get deployment --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgdepslage='kubectl --namespace=kube-system get deployment --show-labels --sort-by=.metadata.creationTimestamp'
alias kgstsslage='kubectl get statefulset --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgstsslage='kubectl --namespace=kube-system get statefulset --show-labels --sort-by=.metadata.creationTimestamp'
alias kgsvcslage='kubectl get service --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgsvcslage='kubectl --namespace=kube-system get service --show-labels --sort-by=.metadata.creationTimestamp'
alias kgingslage='kubectl get ingress --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgingslage='kubectl --namespace=kube-system get ingress --show-labels --sort-by=.metadata.creationTimestamp'
alias kgcmslage='kubectl get configmap --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgcmslage='kubectl --namespace=kube-system get configmap --show-labels --sort-by=.metadata.creationTimestamp'
alias kgsecslage='kubectl get secret --show-labels --sort-by=.metadata.creationTimestamp'
alias ksysgsecslage='kubectl --namespace=kube-system get secret --show-labels --sort-by=.metadata.creationTimestamp'
alias kgnoslage='kubectl get nodes --show-labels --sort-by=.metadata.creationTimestamp'
alias kgnsslage='kubectl get namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgagesl='kubectl get --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgagesl='kubectl --namespace=kube-system get --sort-by=.metadata.creationTimestamp --show-labels'
alias kgpoagesl='kubectl get pods --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgpoagesl='kubectl --namespace=kube-system get pods --sort-by=.metadata.creationTimestamp --show-labels'
alias kgdepagesl='kubectl get deployment --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgdepagesl='kubectl --namespace=kube-system get deployment --sort-by=.metadata.creationTimestamp --show-labels'
alias kgstsagesl='kubectl get statefulset --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgstsagesl='kubectl --namespace=kube-system get statefulset --sort-by=.metadata.creationTimestamp --show-labels'
alias kgsvcagesl='kubectl get service --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgsvcagesl='kubectl --namespace=kube-system get service --sort-by=.metadata.creationTimestamp --show-labels'
alias kgingagesl='kubectl get ingress --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgingagesl='kubectl --namespace=kube-system get ingress --sort-by=.metadata.creationTimestamp --show-labels'
alias kgcmagesl='kubectl get configmap --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgcmagesl='kubectl --namespace=kube-system get configmap --sort-by=.metadata.creationTimestamp --show-labels'
alias kgsecagesl='kubectl get secret --sort-by=.metadata.creationTimestamp --show-labels'
alias ksysgsecagesl='kubectl --namespace=kube-system get secret --sort-by=.metadata.creationTimestamp --show-labels'
alias kgnoagesl='kubectl get nodes --sort-by=.metadata.creationTimestamp --show-labels'
alias kgnsagesl='kubectl get namespaces --sort-by=.metadata.creationTimestamp --show-labels'
...
alias kgallslage='kubectl get --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgpoallslage='kubectl get pods --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgdepallslage='kubectl get deployment --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgstsallslage='kubectl get statefulset --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgsvcallslage='kubectl get service --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgingallslage='kubectl get ingress --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgcmallslage='kubectl get configmap --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgsecallslage='kubectl get secret --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgnsallslage='kubectl get namespaces --all-namespaces --show-labels --sort-by=.metadata.creationTimestamp'
alias kgallagesl='kubectl get --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgpoallagesl='kubectl get pods --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgdepallagesl='kubectl get deployment --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgstsallagesl='kubectl get statefulset --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgsvcallagesl='kubectl get service --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgingallagesl='kubectl get ingress --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgcmallagesl='kubectl get configmap --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgsecallagesl='kubectl get secret --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgnsallagesl='kubectl get namespaces --all-namespaces --sort-by=.metadata.creationTimestamp --show-labels'
alias kgslallage='kubectl get --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgposlallage='kubectl get pods --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgdepslallage='kubectl get deployment --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgstsslallage='kubectl get statefulset --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgsvcslallage='kubectl get service --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgingslallage='kubectl get ingress --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgcmslallage='kubectl get configmap --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgsecslallage='kubectl get secret --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgnsslallage='kubectl get namespaces --show-labels --all-namespaces --sort-by=.metadata.creationTimestamp'
alias kgslageall='kubectl get --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgposlageall='kubectl get pods --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgdepslageall='kubectl get deployment --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgstsslageall='kubectl get statefulset --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgsvcslageall='kubectl get service --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgingslageall='kubectl get ingress --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgcmslageall='kubectl get configmap --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgsecslageall='kubectl get secret --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgnsslageall='kubectl get namespaces --show-labels --sort-by=.metadata.creationTimestamp --all-namespaces'
alias kgageallsl='kubectl get --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgpoageallsl='kubectl get pods --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgdepageallsl='kubectl get deployment --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgstsageallsl='kubectl get statefulset --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgsvcageallsl='kubectl get service --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgingageallsl='kubectl get ingress --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgcmageallsl='kubectl get configmap --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgsecageallsl='kubectl get secret --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgnsageallsl='kubectl get namespaces --sort-by=.metadata.creationTimestamp --all-namespaces --show-labels'
alias kgageslall='kubectl get --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgpoageslall='kubectl get pods --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgdepageslall='kubectl get deployment --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgstsageslall='kubectl get statefulset --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgsvcageslall='kubectl get service --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgingageslall='kubectl get ingress --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgcmageslall='kubectl get configmap --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgsecageslall='kubectl get secret --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
alias kgnsageslall='kubectl get namespaces --sort-by=.metadata.creationTimestamp --show-labels --all-namespaces'
...
alias kgagef='kubectl get --sort-by=.metadata.creationTimestamp --recursive -f'
...
alias kgslagef='kubectl get --show-labels --sort-by=.metadata.creationTimestamp --recursive -f'
alias kgageslf='kubectl get --sort-by=.metadata.creationTimestamp --show-labels --recursive -f'
...
alias kgagel='kubectl get --sort-by=.metadata.creationTimestamp -l'
alias ksysgagel='kubectl --namespace=kube-system get --sort-by=.metadata.creationTimestamp -l'
alias kgpoagel='kubectl get pods --sort-by=.metadata.creationTimestamp -l'
alias ksysgpoagel='kubectl --namespace=kube-system get pods --sort-by=.metadata.creationTimestamp -l'
alias kgdepagel='kubectl get deployment --sort-by=.metadata.creationTimestamp -l'
alias ksysgdepagel='kubectl --namespace=kube-system get deployment --sort-by=.metadata.creationTimestamp -l'
alias kgstsagel='kubectl get statefulset --sort-by=.metadata.creationTimestamp -l'
alias ksysgstsagel='kubectl --namespace=kube-system get statefulset --sort-by=.metadata.creationTimestamp -l'
alias kgsvcagel='kubectl get service --sort-by=.metadata.creationTimestamp -l'
alias ksysgsvcagel='kubectl --namespace=kube-system get service --sort-by=.metadata.creationTimestamp -l'
alias kgingagel='kubectl get ingress --sort-by=.metadata.creationTimestamp -l'
alias ksysgingagel='kubectl --namespace=kube-system get ingress --sort-by=.metadata.creationTimestamp -l'
alias kgcmagel='kubectl get configmap --sort-by=.metadata.creationTimestamp -l'
alias ksysgcmagel='kubectl --namespace=kube-system get configmap --sort-by=.metadata.creationTimestamp -l'
alias kgsecagel='kubectl get secret --sort-by=.metadata.creationTimestamp -l'
alias ksysgsecagel='kubectl --namespace=kube-system get secret --sort-by=.metadata.creationTimestamp -l'
alias kgnoagel='kubectl get nodes --sort-by=.metadata.creationTimestamp -l'
alias kgnsagel='kubectl get namespaces --sort-by=.metadata.creationTimestamp -l'
...
alias kgslagel='kubectl get --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgslagel='kubectl --namespace=kube-system get --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgposlagel='kubectl get pods --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgposlagel='kubectl --namespace=kube-system get pods --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgdepslagel='kubectl get deployment --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgdepslagel='kubectl --namespace=kube-system get deployment --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgstsslagel='kubectl get statefulset --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgstsslagel='kubectl --namespace=kube-system get statefulset --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgsvcslagel='kubectl get service --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgsvcslagel='kubectl --namespace=kube-system get service --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgingslagel='kubectl get ingress --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgingslagel='kubectl --namespace=kube-system get ingress --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgcmslagel='kubectl get configmap --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgcmslagel='kubectl --namespace=kube-system get configmap --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgsecslagel='kubectl get secret --show-labels --sort-by=.metadata.creationTimestamp -l'
alias ksysgsecslagel='kubectl --namespace=kube-system get secret --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgnoslagel='kubectl get nodes --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgnsslagel='kubectl get namespaces --show-labels --sort-by=.metadata.creationTimestamp -l'
alias kgagesll='kubectl get --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgagesll='kubectl --namespace=kube-system get --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgpoagesll='kubectl get pods --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgpoagesll='kubectl --namespace=kube-system get pods --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgdepagesll='kubectl get deployment --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgdepagesll='kubectl --namespace=kube-system get deployment --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgstsagesll='kubectl get statefulset --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgstsagesll='kubectl --namespace=kube-system get statefulset --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgsvcagesll='kubectl get service --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgsvcagesll='kubectl --namespace=kube-system get service --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgingagesll='kubectl get ingress --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgingagesll='kubectl --namespace=kube-system get ingress --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgcmagesll='kubectl get configmap --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgcmagesll='kubectl --namespace=kube-system get configmap --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgsecagesll='kubectl get secret --sort-by=.metadata.creationTimestamp --show-labels -l'
alias ksysgsecagesll='kubectl --namespace=kube-system get secret --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgnoagesll='kubectl get nodes --sort-by=.metadata.creationTimestamp --show-labels -l'
alias kgnsagesll='kubectl get namespaces --sort-by=.metadata.creationTimestamp --show-labels -l'
...
alias kgagen='kubectl get --sort-by=.metadata.creationTimestamp --namespace'
alias kgpoagen='kubectl get pods --sort-by=.metadata.creationTimestamp --namespace'
alias kgdepagen='kubectl get deployment --sort-by=.metadata.creationTimestamp --namespace'
alias kgstsagen='kubectl get statefulset --sort-by=.metadata.creationTimestamp --namespace'
alias kgsvcagen='kubectl get service --sort-by=.metadata.creationTimestamp --namespace'
alias kgingagen='kubectl get ingress --sort-by=.metadata.creationTimestamp --namespace'
alias kgcmagen='kubectl get configmap --sort-by=.metadata.creationTimestamp --namespace'
alias kgsecagen='kubectl get secret --sort-by=.metadata.creationTimestamp --namespace'
...
alias kgslagen='kubectl get --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgposlagen='kubectl get pods --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgdepslagen='kubectl get deployment --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgstsslagen='kubectl get statefulset --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgsvcslagen='kubectl get service --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgingslagen='kubectl get ingress --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgcmslagen='kubectl get configmap --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgsecslagen='kubectl get secret --show-labels --sort-by=.metadata.creationTimestamp --namespace'
alias kgagesln='kubectl get --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgpoagesln='kubectl get pods --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgdepagesln='kubectl get deployment --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgstsagesln='kubectl get statefulset --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgsvcagesln='kubectl get service --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgingagesln='kubectl get ingress --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgcmagesln='kubectl get configmap --sort-by=.metadata.creationTimestamp --show-labels --namespace'
alias kgsecagesln='kubectl get secret --sort-by=.metadata.creationTimestamp --show-labels --namespace'
